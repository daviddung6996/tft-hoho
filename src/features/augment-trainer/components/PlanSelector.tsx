...
export const PlanSelector: React.FC<PlanSelectorProps> = ({
  ...
  const mobileTitle = stage
    ? `${stage}: Kế hoạch của bạn?`
    : "Kế hoạch của bạn?";
      ...
      <div className="plan-selector-container">
        <div className="selector-mobile-shell">
          <div className="plan-selector-header">
            ...
            {allPuzzlesCompleted && (
              <div className="plan-selector-replay-text">
                Bạn đang giải lại tình huống cũ
              </div>
            )}
            <div className="plan-selector-badge">Nhận diện thế bài</div>
            <h3 className="plan-selector-title">
              {stage
                ? `Ở round ${stage} - kế hoạch của bạn?`
                : "Kế hoạch của bạn?"}
            </h3>
            <h3
            ...
            <p className="plan-selector-subtitle">
              ...
              <span className="plan-subtitle-highlight">lobby</span>, rồi chọn
              kế hoạch phù hợp nhất - <em>trước khi chọn lõi</em>.
            </p>
          </div>
          <div
            className="selector-mobile-side-notes"
            data-testid="selector-mobile-helper"
          >
            <p className="selector-mobile-helper selector-mobile-helper--left">
              Xem HP + board
            </p>
            <p className="selector-mobile-helper selector-mobile-helper--right">
              Xem lobby
            </p>
          </div>
