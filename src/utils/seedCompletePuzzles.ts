...
const champImg = (id: string) =>
    `https://raw.communitydragon.org/latest/game/assets/characters/${id.toLowerCase()}/hud/${id.toLowerCase()}_square.tft_set17.png`;
const augIcon = (name: string) =>
    `https://raw.communitydragon.org/pbe/game/assets/maps/tft/icons/augments/hexcore/${name}.tft_set17.png`;
...
const A: Record<string, Aug> = {
    ...
    novaEmblem:    { id: 'TFT17_Item_NovaEmblemItem',          title: 'N.O.V.A. Crown',      description: 'Nhận N.O.V.A. Emblem.',          icon: augIcon('novaemblem'),        tier: 2 },
...
const earlyOpps = (hp: number[]): OpponentData[] => [
    mkOpp('opp-1', 'Soju小辉', hp[0], 5, 3, [
        { cid: 'TFT17_Aatrox', n: 'Aatrox', r: 0, c: 3, cost: 1, s: 2 },
        { cid: 'TFT17_Teemo', n: 'Teemo', r: 0, c: 4, cost: 1, s: 1 },
        { cid: 'TFT17_Veigar', n: 'Veigar', r: 1, c: 3, cost: 1, s: 1 },
    ]),
    mkOpp('opp-2', 'MilkCha', hp[1], 4, 3, [
        { cid: 'TFT17_Nasus', n: 'Nasus', r: 0, c: 3, cost: 1, s: 2 },
        { cid: 'TFT17_Lissandra', n: 'Lissandra', r: 0, c: 4, cost: 1, s: 1 },
    ]),
    mkOpp('opp-3', 'BoxBox', hp[2], 3, 3, [
        { cid: 'TFT17_Briar', n: 'Briar', r: 0, c: 3, cost: 1, s: 1 },
        { cid: 'TFT17_Poppy', n: 'Poppy', r: 0, c: 4, cost: 1, s: 1 },
        { cid: 'TFT17_Ezreal', n: 'Ezreal', r: 1, c: 3, cost: 1, s: 1 },
    ]),
    mkOpp('opp-4', 'Frodan', hp[3], 6, 3, [
        { cid: 'TFT17_Jax', n: 'Jax', r: 0, c: 3, cost: 2, s: 1 },
        { cid: 'TFT17_Akali', n: 'Akali', r: 0, c: 4, cost: 2, s: 1 },
    ]),
    mkOpp('opp-5', 'Kiyoon', hp[4], 5, 3, [
        { cid: 'TFT17_Nasus', n: 'Nasus', r: 0, c: 2, cost: 1, s: 1 },
        { cid: 'TFT17_Aatrox', n: 'Aatrox', r: 0, c: 4, cost: 1, s: 1 },
    ]),
    mkOpp('opp-6', 'Bebe872', hp[5], 4, 3, [
        { cid: 'TFT17_Veigar', n: 'Veigar', r: 0, c: 3, cost: 1, s: 1 },
        { cid: 'TFT17_Briar', n: 'Briar', r: 1, c: 3, cost: 1, s: 2 },
    ]),
    mkOpp('opp-7', 'Keane', hp[6], 3, 3, [
        { cid: 'TFT17_Teemo', n: 'Teemo', r: 0, c: 3, cost: 1, s: 1 },
        { cid: 'TFT17_Poppy', n: 'Poppy', r: 0, c: 4, cost: 1, s: 1 },
    ]),
];
...
const midOpps = (hp: number[]): OpponentData[] => [
    mkOpp('opp-1', 'Wasion', hp[0], 20, 6, [
        { cid: 'TFT17_Jax', n: 'Jax', r: 0, c: 2, cost: 2, s: 2 },
        { cid: 'TFT17_Akali', n: 'Akali', r: 0, c: 3, cost: 2, s: 2 },
        { cid: 'TFT17_Aatrox', n: 'Aatrox', r: 0, c: 4, cost: 1, s: 2 },
        { cid: 'TFT17_Jinx', n: 'Jinx', r: 1, c: 3, cost: 2, s: 1, itm: ['GuinsoosRageblade'] },
    ]),
    mkOpp('opp-2', 'Soju小辉', hp[1], 18, 6, [
        { cid: 'TFT17_Kindred', n: 'Kindred', r: 0, c: 3, cost: 4, s: 1, itm: ['InfinityEdge'] },
        { cid: 'TFT17_Mordekaiser', n: 'Mordekaiser', r: 0, c: 2, cost: 2, s: 2 },
        { cid: 'TFT17_Nasus', n: 'Nasus', r: 1, c: 3, cost: 1, s: 2 },
    ]),
    mkOpp('opp-3', 'MilkCha', hp[2], 15, 5, [
        { cid: 'TFT17_Briar', n: 'Briar', r: 0, c: 3, cost: 1, s: 2 },
        { cid: 'TFT17_Veigar', n: 'Veigar', r: 0, c: 4, cost: 1, s: 2 },
        { cid: 'TFT17_Poppy', n: 'Poppy', r: 1, c: 3, cost: 1, s: 2 },
        { cid: 'TFT17_Ezreal', n: 'Ezreal', r: 1, c: 4, cost: 1, s: 2 },
    ]),
    mkOpp('opp-4', 'BoxBox', hp[3], 22, 6, [
        { cid: 'TFT17_Maokai', n: 'Maokai', r: 0, c: 3, cost: 3, s: 2, itm: ['HandOfJustice'] },
        { cid: 'TFT17_Ezreal', n: 'Ezreal', r: 0, c: 4, cost: 1, s: 2 },
        { cid: 'TFT17_Jax', n: 'Jax', r: 1, c: 3, cost: 2, s: 2 },
    ]),
    mkOpp('opp-5', 'Kiyoon', hp[4], 12, 5, [
        { cid: 'TFT17_Lissandra', n: 'Lissandra', r: 0, c: 3, cost: 1, s: 2 },
        { cid: 'TFT17_Teemo', n: 'Teemo', r: 0, c: 4, cost: 1, s: 2 },
        { cid: 'TFT17_Aurora', n: 'Aurora', r: 1, c: 3, cost: 3, s: 1 },
    ]),
    mkOpp('opp-6', 'Bebe872', hp[5], 25, 6, [
        { cid: 'TFT17_Xayah', n: 'Xayah', r: 0, c: 3, cost: 4, s: 1, itm: ['GuinsoosRageblade'] },
        { cid: 'TFT17_Diana', n: 'Diana', r: 0, c: 2, cost: 3, s: 2 },
        { cid: 'TFT17_Pantheon', n: 'Pantheon', r: 1, c: 2, cost: 2, s: 2 },
    ]),
    mkOpp('opp-7', 'Frodan', hp[6], 16, 6, [
        { cid: 'TFT17_Rhaast', n: 'Rhaast', r: 0, c: 3, cost: 3, s: 1 },
        { cid: 'TFT17_Mordekaiser', n: 'Mordekaiser', r: 0, c: 2, cost: 2, s: 2 },
        { cid: 'TFT17_Aatrox', n: 'Aatrox', r: 1, c: 3, cost: 1, s: 2 },
    ]),
];
...
const DEFS: PuzzleDef[] = [
    // ══ P1: 2-1 FREE — Dishsoap Econ ══
    {
        ...
        title: 'Dishsoap — Econ hay Item?', patch: '17.1', date: '2026-03-28', server: 'NA',
        ...
        board: [
            { cid: 'TFT17_Jax', n: 'Jax', r: 0, c: 3, cost: 2, s: 1 },
            { cid: 'TFT17_Poppy', n: 'Poppy', r: 0, c: 4, cost: 1, s: 1 },
            { cid: 'TFT17_Akali', n: 'Akali', r: 1, c: 3, cost: 2, s: 1 },
        ],
    ...
    // ══ P2: 2-1 ADVANCED — Soju Reroll ══
    {
        ...
        title: 'Soju — Item cho Reroll hay Econ?', patch: '17.1', date: '2026-03-28', server: 'NA',
        ...
        board: [
            { cid: 'TFT17_Briar', n: 'Briar', r: 0, c: 3, cost: 1, s: 2 },
            { cid: 'TFT17_Veigar', n: 'Veigar', r: 0, c: 4, cost: 1, s: 1 },
            { cid: 'TFT17_Lissandra', n: 'Lissandra', r: 1, c: 3, cost: 1, s: 1 },
        ],
        state: { hp: 100, gold: 3, level: 3 },
        bench: [{ cid: 'TFT17_Nasus', n: 'Nasus', r: -1, c: 0, cost: 1, s: 1 }],
    ...
    // ══ P3: 2-1 RARE — Pengu Prismatic ══
    {
        ...
        title: 'Pengu — Prismatic Econ Dream', patch: '17.1', date: '2026-03-28', server: 'KR',
    ...
    // ══ P4: 2-1 FREE — k3soju Items ══
    {
        ...
        title: 'k3soju — 2 Items miễn phí hay AP boost?', patch: '17.1', date: '2026-03-28', server: 'NA',
        ...
        board: [
            { cid: 'TFT17_Aatrox', n: 'Aatrox', r: 0, c: 3, cost: 1, s: 2 },
            { cid: 'TFT17_Teemo', n: 'Teemo', r: 0, c: 5, cost: 1, s: 1 },
            { cid: 'TFT17_Akali', n: 'Akali', r: 1, c: 4, cost: 2, s: 1 },
        ],
    ...
    // ══ P5: 2-1 ADVANCED — Ramblinnn ══
    {
        ...
        title: 'Ramblinnn — Glass Cannon hay Iron Assets?', patch: '17.1', date: '2026-03-28', server: 'NA',
    ...
    // ══ P6: 3-2 FREE — Wasion V2 (econ) ══
    {
        ...
        title: 'Wasion 3-2 — Econ Intent', patch: '17.1', date: '2026-03-28', server: 'KR',
        ...
        pick: A.clearMind, pickRound: 0, pickIndex: 0,
        board: [
            { cid: 'TFT17_Jax', n: 'Jax', r: 0, c: 3, cost: 2, s: 2 },
            { cid: 'TFT17_Poppy', n: 'Poppy', r: 0, c: 4, cost: 1, s: 2, itm: ['GuinsoosRageblade'] },
            { cid: 'TFT17_Akali', n: 'Akali', r: 1, c: 3, cost: 2, s: 2 },
            { cid: 'TFT17_Aatrox', n: 'Aatrox', r: 1, c: 4, cost: 1, s: 2 },
            { cid: 'TFT17_Nasus', n: 'Nasus', r: 0, c: 2, cost: 1, s: 2 },
        ],
    ...
    // ══ P7: 3-2 ADVANCED — Becca (item) ══
    {
        ...
        title: 'Becca 3-2 — Item cho Jinx carry', patch: '17.1', date: '2026-03-28', server: 'NA',
        ...
        pick: A.backupBows, pickRound: 0, pickIndex: 0,
        board: [
            { cid: 'TFT17_Jinx', n: 'Jinx', r: 0, c: 3, cost: 2, s: 2, itm: ['InfinityEdge'] },
            { cid: 'TFT17_Jax', n: 'Jax', r: 0, c: 2, cost: 2, s: 2 },
            { cid: 'TFT17_Veigar', n: 'Veigar', r: 1, c: 2, cost: 1, s: 2 },
            { cid: 'TFT17_Poppy', n: 'Poppy', r: 1, c: 3, cost: 1, s: 2 },
            { cid: 'TFT17_Aatrox', n: 'Aatrox', r: 0, c: 1, cost: 1, s: 2 },
        ],
    ...
    // ══ P8: 3-2 RARE — Milk (combat) ══
    {
        ...
        title: 'Milk 3-2 — Combat hay Econ khi low HP?', patch: '17.1', date: '2026-03-28', server: 'NA',
        explanation: '55 HP, cần combat power ngay. Ascension +75% dmg sau 15s — Kindred carry scale cực mạnh. Glass Cannon rủi ro khi HP thấp.',
        ...
        board: [
            { cid: 'TFT17_Kindred', n: 'Kindred', r: 0, c: 3, cost: 4, s: 2, itm: ['InfinityEdge', 'Bloodthirster'] },
            { cid: 'TFT17_Jax', n: 'Jax', r: 0, c: 1, cost: 2, s: 2 },
            { cid: 'TFT17_Pantheon', n: 'Pantheon', r: 0, c: 2, cost: 2, s: 2 },
            { cid: 'TFT17_Mordekaiser', n: 'Mordekaiser', r: 1, c: 1, cost: 2, s: 1 },
            { cid: 'TFT17_Rhaast', n: 'Rhaast', r: 1, c: 2, cost: 3, s: 1 },
            { cid: 'TFT17_Ezreal', n: 'Ezreal', r: 1, c: 4, cost: 1, s: 2 },
        ],
        state: { hp: 55, gold: 8, level: 7 },
        items: [],
        opps: midOpps([72, 85, 60, 78, 55, 90, 68]),
        v2: { streak: [false, false, false, true, true], cnt: 2, path: 'combat', reason: 'HP thấp (55), cần power spike gấp. Kindred đã có IE+BT, Ascension cho +75% dmg late fight.', diff: 'close_call' },
    },
    // ══ P9: 3-2 ADVANCED — Guubums (emblem) ══
    {
        pro: 'Guubums', rank: 'Grandmaster', stage: '3-2', tier: 'advanced',
        title: 'Guubums 3-2 — Emblem cho N.O.V.A.', patch: '17.1', date: '2026-03-28', server: 'EUW',
        explanation: 'Maokai carry + Aatrox = 2 N.O.V.A. Thêm Emblem = 3 N.O.V.A. bonus trait mạnh. Emblem path vì synergy value lớn hơn raw items.',
        firstRoll: [A.novaEmblem, A.epicRolldown, A.bodyguard],
        reroll:    [A.ascension, A.advLoan, A.celestial2],
        secondRoll: [], proRerollIdx: [], proSecondRerollIdx: [],
        pick: A.novaEmblem, pickRound: 0, pickIndex: 0,
        board: [
            { cid: 'TFT17_Maokai', n: 'Maokai', r: 0, c: 3, cost: 3, s: 2, itm: ['HandOfJustice'] },
            { cid: 'TFT17_Ezreal', n: 'Ezreal', r: 0, c: 4, cost: 1, s: 2 },
            { cid: 'TFT17_Aatrox', n: 'Aatrox', r: 1, c: 2, cost: 1, s: 2 },
            { cid: 'TFT17_Jax', n: 'Jax', r: 1, c: 3, cost: 2, s: 2 },
        ],
        state: { hp: 72, gold: 15, level: 6 },
        items: [{ id: 'TFT_Item_ChainVest', name: 'Chain Vest' }],
        opps: midOpps([78, 80, 66, 85, 62, 88, 70]),
        v2: { streak: [true, false, true, true, true], cnt: 3, path: 'emblem', reason: 'Maokai+Aatrox = 2 N.O.V.A. Crown cho 3 N.O.V.A. breakpoint. Synergy value > raw item/econ.', diff: 'counter_intuitive' },
    },
    // ══ P10: 3-2 RARE — Frodan (item prismatic) ══
    {
        pro: 'Frodan', rank: 'Challenger', stage: '3-2', tier: 'rare',
        title: 'Frodan 3-2 — Prismatic Items cho Xayah', patch: '17.1', date: '2026-03-28', server: 'NA',
        explanation: 'Xayah carry chỉ có 1 Guinsoo. Band of Thieves II = 2 full items instant. Hedge Fund ở 3-2 quá muộn cho econ.',
        ...
        board: [
            { cid: 'TFT17_Xayah', n: 'Xayah', r: 0, c: 3, cost: 4, s: 2, itm: ['GuinsoosRageblade'] },
            { cid: 'TFT17_Mordekaiser', n: 'Mordekaiser', r: 0, c: 1, cost: 2, s: 2 },
            { cid: 'TFT17_Pantheon', n: 'Pantheon', r: 0, c: 2, cost: 2, s: 2 },
            { cid: 'TFT17_Aurora', n: 'Aurora', r: 1, c: 3, cost: 3, s: 1 },
            { cid: 'TFT17_Diana', n: 'Diana', r: 1, c: 2, cost: 3, s: 2 },
            { cid: 'TFT17_Teemo', n: 'Teemo', r: 1, c: 4, cost: 1, s: 2 },
        ],
        state: { hp: 62, gold: 10, level: 7 },
        items: [],
        opps: midOpps([80, 75, 58, 82, 52, 88, 65]),
        v2: { streak: [true, false, false, false, true], cnt: 1, path: 'item', reason: 'Xayah carry thiếu items — chỉ có 1 Guinsoo. Band of Thieves II = 2 full items instant power spike.', diff: 'straightforward' },
    },
];
